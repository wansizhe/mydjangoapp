...
from mydjangoapp.asgi import channel_layer
...
class Pool:
    ...
    def check_match(self, a, b):
        ...
        a_max = a.waiting_time * 50
        b_max = b.waiting_time * 50
        return diff <= a_max and diff <= b_max
    ...
    def match_success(self, ps):
        ...
        cache.set(room_name, players, 60*60*1)
        for p in ps:
