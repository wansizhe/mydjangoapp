...
from game.views.settings.acwing.web.reveive_code import receive_code as web_receive_code
from game.views.settings.acwing.acapp.apply_code import apply_code as acapp_apply_code
from game.views.settings.acwing.acapp.reveive_code import receive_code as acapp_receive_code
